"""
Discord Movie Night Bot - Simple version with auto-updating
...
async def update_movie_announcements():
    ...
    for message_id, data in active_announcements.items():
        try:
            ...
            print(f"Error in update loop for message {message_id}: {e}")
...
async def movie_command(interaction: discord.Interaction, name: str, time: str):
    ...
    try:
        ...
        try:
            ...
            print(f"Error storing announcement for auto-update: {e}")
